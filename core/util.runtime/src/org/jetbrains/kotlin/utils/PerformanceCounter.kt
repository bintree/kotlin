...
val getJavaMethodsNonDeclared = PerformanceCounter.create("LazyJavaScope.methods: computing non-declared")
val getJavaMethodsComputingSupertypes = PerformanceCounter.create("LazyJavaScope.methods: computing supertypes")
val getJavaMethodsGettingFunctionsFromSupertypes = PerformanceCounter.create("LazyJavaScope.methods: getting functions from supertypes")
...
val getJavaMethodsResolvePropagatedSignature = PerformanceCounter.create("LazyJavaScope.methods: resolvePropagatedSignature")
