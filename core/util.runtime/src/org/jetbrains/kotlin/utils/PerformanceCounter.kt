...
val perfCounter3 = PerformanceCounter.create("ClassReader.accept for binary Java classes")
val perfCounter4 = PerformanceCounter.create("ClassReader.accept for binary inner Java classes")
val perfCounter5 = PerformanceCounter.create("ClassReader.accept with empty visitor")
val perfCounter6 = PerformanceCounter.create("contentsToByteArray for Java classfile")
val perfCounter7 = PerformanceCounter.create("com.intellij.mock.MockFileIndexFacade.isInLibraryClasses")
val perfCounter8 = PerformanceCounter.create("com.intellij.psi.impl.compiled.InnerClassSourceStrategy.findInnerClass")
