...
package org.jetbrains.kotlin.codegen.optimization.variables
...
class ReachingDefinitionsValue private (storedValue: BasicValue) : BasicValue(storedValue.getType()) {
    ...
    fun merge(other: ReachingDefinitionsValue): ReachingDefinitionsValue {
        val merged = ReachingDefinitionsValue(basicValue!!)
        merged.definitionIndices.addAll(definitionIndices)
        merged.definitionIndices.addAll(other.definitionIndices)
        return merged
    }
