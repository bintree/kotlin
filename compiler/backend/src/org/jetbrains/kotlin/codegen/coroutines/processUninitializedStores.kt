...
private class UninitializedNewValueFrame(nLocals: Int, nStack: Int) : MethodFrame<BasicValue>(nLocals, nStack) {
 ...
 */
private fun MethodFrame<BasicValue>.getUninitializedValueForConstructorCall(
