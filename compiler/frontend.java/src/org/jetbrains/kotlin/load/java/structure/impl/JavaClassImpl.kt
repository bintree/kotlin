...
import org.jetbrains.kotlin.utils.queryMethods
...
class JavaClassImpl(psiClass: PsiClass) : JavaClassifierImpl<PsiClass>(psiClass), JavaClass, JavaAnnotationOwnerImpl, JavaModifierListOwnerImpl {
    ...
    override val methods: Collection<JavaMethod>
        get() {
            ...
            return queryMethods.time {
                methods(psi.methods.filter { method -> !method.isConstructor && method.returnType != null }).distinct()
            }
        }
