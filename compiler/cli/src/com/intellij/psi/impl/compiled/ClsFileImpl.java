...
public class ClsFileImpl extends ClsRepositoryPsiElement<PsiClassHolderFileStub>
        ...
        try {
            ...
            if (module) {
                ...
                try {
                    ...
                    final StubBuildingVisitor<FileContentPair> visitor = new StubBuildingVisitor<FileContentPair>(source, STRATEGY, stub, 0, className);
                    PerformanceCounterKt.getPerfCounter3().time(new Function0<Object>() {
                        @Override
                        public Object invoke() {
                            reader.accept(visitor, EMPTY_ATTRIBUTES, ClassReader.SKIP_FRAMES | ClassReader.SKIP_DEBUG | ClassReader.SKIP_CODE);
                            return null;
                        }
                    })
                    ;
    ...
    private static final InnerClassSourceStrategy<FileContentPair> STRATEGY = new InnerClassSourceStrategy<FileContentPair>() {
        @Nullable
        @Override
        public FileContentPair findInnerClass(final String innerName, final FileContentPair outerClass) {
            return PerformanceCounterKt.getPerfCounter8().time(new Function0<FileContentPair>() {
                @Override
                public FileContentPair invoke() {
        ...
        @Override
        public void accept(final FileContentPair innerClass, final StubBuildingVisitor<FileContentPair> visitor) {
            PerformanceCounterKt.getPerfCounter4().time(new Function0<Object>() {
                @Override
                public Object invoke() {
                    new ClassReader(innerClass.second).accept(visitor, EMPTY_ATTRIBUTES, ClassReader.SKIP_FRAMES | ClassReader.SKIP_DEBUG | ClassReader.SKIP_CODE);
                    return null;
                }
            });
        }
